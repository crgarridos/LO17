// $ANTLR 3.5.1 /volsme/users/lo17p016/Documents/INDEX/LO17/TD4/tal_sql.g 2015-04-24 16:13:02
...
public class tal_sqlParser extends Parser {
	...
	public final Arbre requete() throws RecognitionException {
		...
		try {
			...
			// /volsme/users/lo17p016/Documents/INDEX/LO17/TD4/tal_sql.g:79:3: (|dt= date )
			int alt4=2;
			int LA4_0 = input.LA(1);
			if ( (LA4_0==MOT) ) {
				alt4=1;
			}
			else if ( (LA4_0==ANNEE||(LA4_0 >= JOUR && LA4_0 <= MOIS)) ) {
				alt4=2;
			}
			...
			switch (alt4) {
				case 1 :
					// /volsme/users/lo17p016/Documents/INDEX/LO17/TD4/tal_sql.g:79:4: 
					{
					}
					break;
				case 2 :
					// /volsme/users/lo17p016/Documents/INDEX/LO17/TD4/tal_sql.g:79:6: dt= date
					{
			...
			match(input,MOT,FOLLOW_MOT_in_requete514); 

							req_arbre.ajouteFils(new Arbre("","from titreresume"));
							req_arbre.ajouteFils(new Arbre("","where"));
						
			pushFollow(FOLLOW_params_in_requete531);
			ps=params();
			state._fsp--;
	...
	public final Arbre date() throws RecognitionException {
		...
		try {
			...
			{
			// /volsme/users/lo17p016/Documents/INDEX/LO17/TD4/tal_sql.g:98:3: (| JOUR )
			int alt5=2;
			int LA5_0 = input.LA(1);
			if ( (LA5_0==ANNEE||(LA5_0 >= MOIS && LA5_0 <= MOT)) ) {
				alt5=1;
			}
			else if ( (LA5_0==JOUR) ) {
				alt5=2;
			...
			switch (alt5) {
				case 1 :
					...
					break;
				case 2 :
					// /volsme/users/lo17p016/Documents/INDEX/LO17/TD4/tal_sql.g:98:5: JOUR
					{
			...
			// /volsme/users/lo17p016/Documents/INDEX/LO17/TD4/tal_sql.g:102:3: (| MOIS )
			int alt6=2;
			int LA6_0 = input.LA(1);
			if ( (LA6_0==ANNEE||LA6_0==MOT) ) {
				alt6=1;
			}
			else if ( (LA6_0==MOIS) ) {
				alt6=2;
			...
			switch (alt6) {
				case 1 :
					// /volsme/users/lo17p016/Documents/INDEX/LO17/TD4/tal_sql.g:102:4: 
					{
					}
					break;
				case 2 :
					// /volsme/users/lo17p016/Documents/INDEX/LO17/TD4/tal_sql.g:102:6: MOIS
					{
					match(input,MOIS,FOLLOW_MOIS_in_date569); 
			...
			// /volsme/users/lo17p016/Documents/INDEX/LO17/TD4/tal_sql.g:106:3: (| ANNEE )
			int alt7=2;
			...
			switch (alt7) {
				case 1 :
					// /volsme/users/lo17p016/Documents/INDEX/LO17/TD4/tal_sql.g:106:4: 
					{
					}
					break;
				case 2 :
					// /volsme/users/lo17p016/Documents/INDEX/LO17/TD4/tal_sql.g:106:6: ANNEE
					{
					match(input,ANNEE,FOLLOW_ANNEE_in_date582); 
	...
	public final Arbre params() throws RecognitionException {
		...
		try {
			...
			{
			pushFollow(FOLLOW_param_in_params614);
			par1=param();
			state._fsp--;
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_conj_in_params629);
					par2=conj();
					state._fsp--;
					...
					pushFollow(FOLLOW_param_in_params644);
					par3=param();
					state._fsp--;
		...
		try {
			...
			switch (alt9) {
				case 1 :
					...
					{
					match(input,AND,FOLLOW_AND_in_conj672); 
				...
				case 2 :
					...
					{
					match(input,OR,FOLLOW_OR_in_conj682); 
	...
	public final Arbre param() throws RecognitionException {
		...
		try {
			...
			{
			a=(Token)match(input,VAR,FOLLOW_VAR_in_param706); 
	...
	public static final BitSet FOLLOW_date_in_requete503 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_MOT_in_requete514 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_params_in_requete531 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_JOUR_in_date554 = new BitSet(new long[]{0x0000000000000222L});
	public static final BitSet FOLLOW_MOIS_in_date569 = new BitSet(new long[]{0x0000000000000022L});
	public static final BitSet FOLLOW_ANNEE_in_date582 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_param_in_params614 = new BitSet(new long[]{0x0000000000000812L});
	public static final BitSet FOLLOW_conj_in_params629 = new BitSet(new long[]{0x0000000000008000L});
	public static final BitSet FOLLOW_param_in_params644 = new BitSet(new long[]{0x0000000000000812L});
	public static final BitSet FOLLOW_AND_in_conj672 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_OR_in_conj682 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_VAR_in_param706 = new BitSet(new long[]{0x0000000000000002L});
}
